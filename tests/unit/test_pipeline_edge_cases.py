...
class TestPipelineEdgeCases(unittest.TestCase):
    ...
    def test_network_error_handling(self, mock_scrape):
        ...
        result = self.pipeline._process_single_url("https://example.com", "markdown", False)
    ...
    def test_invalid_chunking_strategy(self):
        ...
        with mock.patch("RAGnificent.core.config.get_config") as mock_config:
            ...
            self.assertEqual(len(chunks), 0, "Invalid chunking strategy should yield no chunks")
    ...
    def test_embedding_failure(self, mock_get_embedding):
        ...
        self.assertEqual(result, chunks, "Should return original chunks without embeddings on failure")
    ...
    def test_store_chunks_without_embeddings(self):
        ...
        self.assertFalse(result, "Storing chunks without embeddings should return False")
