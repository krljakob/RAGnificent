...
from RAGnificent.rag.embedding import EmbeddingService, get_embedding_service
from RAGnificent.rag.vector_store import VectorStore, get_vector_store
from RAGnificent.rag.search import SearchResult, SemanticSearch, get_search
...
class Pipeline:
    ...
    def __init__(
        ...
        self.scraper = MarkdownScraper(
            ...
            cache_enabled=cache_enabled if cache_enabled is not None else self.config.scraper.cache_enabled
        )
