...
class ResourceManager:
    ...
    def get_memory_usage(self) -> Dict[str, float]:
        ...
        return {
            ...
            "system_total_mb": virtual_memory.total / (1024 * 1024),  # Total system memory in MB
            "system_available_mb": virtual_memory.available / (1024 * 1024),  # Available system memory in MB
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        with self.lock:
            return {
                ...
                "idle": self.idle,
                "in_use": self.active,
                "utilization": self.active / self.max_connections if self.max_connections > 0 else 0,
            }
...
class MemoryMonitor:
    ...
    def get_backpressure_delay(self) -> float:
        ...
        if memory_percent >= self.critical_threshold:
            ...
            severity = (memory_percent - self.warning_threshold) / (self.critical_threshold - self.warning_threshold)
